...
const projects = [
  {
    ...
    desc:'A platform to help users organize groceries and manage shopping lists efficiently.'
  },
  {
    title:'Study Pilot',
    ...
    desc:'Helps students manage study schedules, track progress, and increase productivity.'
  },
  {
    ...
    emoji:'❤️',
    badge:'Wellbeing',
    subtitle:'Wellbeing Reminder App',
    desc:'Designed to remind users of personal moments and wellness tasks daily.'
  },
  {
    ...
    emoji:'💑',
    badge:'Consumer',
    subtitle:'Relationship Management Platform',
    desc:'Helps couples manage shared goals and strengthen communication in their relationship.'
  },
  {
    ...
    emoji:'🧠',
    badge:'Game',
    subtitle:'Tech Quiz & Learning Game',
    desc:'Gamified platform for competing in tech quizzes while boosting knowledge retention.'
  },
];

// Select the projects grid
